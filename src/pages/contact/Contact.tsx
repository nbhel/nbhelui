    ...
    <>
      ...
      <section className="text-gray-600 body-font relative bg-black">
        <div className="container px-5 py-12 mx-auto flex flex-col ">
          <div className="lg:w-1/3 md:w-1/2 bg-white rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0 relative z-10 shadow-md sm:mb-8 mb-16 lg:mb-0 mr-10">
